$(document).ready(function () {         // jQuery detects the state of readiness for code to execute safely
    $("#json_beautify").jsonToWeb({
      // Plugin invocation inside a container having this class
      // Compulsory settings
      imagesPath: "images/strollers/", //Image path must be specified and image names correspond to product/employee/...
      jsonSource:
        "https://raw.githubusercontent.com/Relatora/Everalda/master/strollers.json", // source can be a json array or a json address
